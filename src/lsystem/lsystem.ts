...
export default class LSystem {
    ...
    numRays: number;
    roadSegLength: number;

    constructor(height: TextureReader, water: TextureReader, popul: TextureReader, pt: number, nr: number, rl: number) {
    ...
    reset(pt: number, nr: number, rl: number) {
        this.edgeData = [];
        this.isectData = [];
        this.highways = [];
        this.roadIsects = [];
